...
> This is the change that was intended for v2.1.2; that tag had already been published to Packagist pointing at a different commit, so the fix ships here instead.
